...
const PyleraIndicationAndUsage = ({ navigation }) => {
    ...
    <View style={styles.container}>
      ...
      <ScrollView style={styles.scrollContainer}>
        ...
        <Text style={styles.bulletTextContent}>
          {SCREEN_CONTENT[language].pylera.content.indicationAndUsage.content.textBlock1}
        </Text>
        <Text style={styles.bulletTextContent}>
          {SCREEN_CONTENT[language].pylera.content.indicationAndUsage.content.textBlock2}
        </Text>
      ...
      <View style={styles.buttons}>
        ...
        <TouchableOpacity style={styles.nextButton} onPress={() => navigation.navigate(ROUTES.PYLERA_DOSE_EDUCATION)}>
...
export default PyleraIndicationAndUsage;